...
<p>
  <strong>一个帮助你阅读文献的 Skill，适用于 Claude Code、Codex、OpenClaw 以及其他支持 Skill 的 Agent / IDE / 大模型。</strong><br/>
...
**老奶奶读文献.skill** 是一个给“看不懂但想看懂论文的人”准备的 Skill。  
它不只做翻译或摘要，而是把论文里的包装拆掉，解释难以理解的词汇，并把真正重要的观点、方法、创新点和局限讲清楚。并在结尾给予提问建议。

### 能力

- `概读`：快速抓住论文在解决什么问题、核心思路是什么、创新点大小。
- `精读`：拆开模型结构、训练逻辑、推理流程，讲清方法原理。
